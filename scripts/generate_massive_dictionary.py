...
MASTER_WORDS = [
    ...
    # Articles & Determiners & Fundamental Words
    ("the", "o, belirli nesne (belirteç)", "Belirteç (Article)", "🔹"),
    ("a", "bir (herhangi bir)", "Belirteç (Article)", "🔹"),
    ("an", "bir (sesli harf öncesi)", "Belirteç (Article)", "🔹"),
    ("and", "ve, ile", "Bağlaç (Conjunction)", "➕"),
    ("or", "veya, ya da", "Bağlaç (Conjunction)", "🔀"),
    ("but", "ama, fakat, lakin", "Bağlaç (Conjunction)", "✋"),
    ("is", "-dir/-dır (tekil olmak fiili)", "Yardımcı Fiil (Verb to be)", "🔵"),
    ("are", "-dirler/-dırlar (çoğul olmak fiili)", "Yardımcı Fiil (Verb to be)", "🔵"),
    ("am", "-im/-ım (ben olmak fiili)", "Yardımcı Fiil (Verb to be)", "🔵"),
    ("was", "idi (geçmiş tekil olmak fiili)", "Geçmiş Yardımcı Fiil", "⏳"),
    ("were", "idiler (geçmiş çoğul olmak fiili)", "Geçmiş Yardımcı Fiil", "⏳"),
    ("of", "-in, -ın / -den (aitlik / parça)", "Edat (Preposition)", "🟡"),
    ("as", "olarak / gibi / iken (-dıkça)", "Edat / Bağlaç", "🟡"),
    ("one", "bir / biri, bir tanesi", "Sayı / Belgisiz Zamir", "1️⃣"),
    ("two", "iki", "Sayı", "2️⃣"),
    ("three", "üç", "Sayı", "3️⃣"),
    ("peopleagd", "yaşındaki insanlar (people aged OCR düzeltmesi)", "İsim Tamlaması", "👥"),
    ("aged", "yaşında, yaşlanmış", "Sıfat (Adjective)", "👴"),
    ("age", "yaş / çağ, devir", "İsim (Noun)", "🎂"),
    ("this", "bu (yakındaki tekil)", "İşaret Sıfatı / Zamiri", "👉"),
    ("that", "şu, o (uzaktaki tekil)", "İşaret Sıfatı / Zamiri", "👉"),
    ("these", "bunlar (yakındaki çoğul)", "İşaret Sıfatı / Zamiri", "👉"),
    ("those", "şunlar, onlar (uzaktaki çoğul)", "İşaret Sıfatı / Zamiri", "👉"),
    ("english", "İngilizce / İngiliz", "İsim / Sıfat (Language)", "🇬🇧"),
    ("level", "seviye, düzey, kademe", "İsim (Noun)", "📊"),
    ("levels", "seviyeler, düzeyler", "Çoğul İsim", "📊"),
    ("pre", "ön, öncül (orta seviye öncesi vb.)", "Önek / Sıfat", "📐"),
    ("pre-intermediate", "orta seviye öncesi (A2+)", "Sıfat (Level)", "⚖️"),
    ("intermediate", "orta seviye (B1)", "Sıfat (Level)", "⚖️"),
    ("elementary", "başlangıç-temel seviye (A1/A2)", "Sıfat (Level)", "🌱"),
    ("upper-intermediate", "orta-ileri seviye (B2)", "Sıfat (Level)", "🚀"),
    ("proficiency", "yetkinlik, yeterlilik, dil becerisi", "İsim (Language)", "⭐"),
    ("confidence", "özgüven, inanç, itimat", "İsim (Psychology)", "🦁"),
    ("competence", "yetkinlik, ehliyet, beceri", "İsim (Academic)", "🎯"),
    ("crucial", "hayati, çok önemli, kritik", "Sıfat (Academic)", "⚡"),
    ("role", "rol, görev, işlev", "İsim (Noun)", "🎭"),
    ("vital", "hayati, yaşamsal, çok mühim", "Sıfat (Academic)", "❤️"),
    ("attention", "dikkat, ilgi, odaklanma", "İsim (Psychology)", "👀"),
    ("unexpected", "beklenmedik, umulmadık, sürpriz", "Sıfat (Adjective)", "😲"),
    ("every", "her, her bir", "Belirteç", "🔢"),
    ("now", "şimdi, şu anda", "Zaman Zarfı", "⏰"),
    ("then", "o zaman, sonra, öyleyse", "Zaman Zarfı / Bağlaç", "⏳"),
    ("stepping", "adım atma, giriş yapma", "İsim / Fiil (-ing)", "👣"),
    ("step", "adım / adım atmak", "İsim / Fiil", "👣"),
    ("steps", "adımlar", "Çoğul İsim", "👣"),
    ("second", "ikinci / saniye", "Sıra Sayısı / İsim", "🥈"),
    ("use", "kullanmak / kullanım, yarar", "Fiil / İsim", "🔧"),
    ("using", "kullanarak, kullanım", "Fiil (-ing) / İsim", "🔧"),
    ("used", "kullanılmış / alışkın / kullandı", "Sıfat / Fiil (V2/V3)", "🔧"),
    ("uses", "kullanımlar / kullanır", "Çoğul İsim / Fiil (3. Tekil)", "🔧"),
    ("topic", "konu, başlık, tema", "İsim (Noun)", "📌"),
    ("topics", "konular, başlıklar", "Çoğul İsim", "📌"),
    ("capture", "yakalamak, çekmek (dikkat/ilgi)", "Fiil (Action)", "🎣"),
    ("captures", "yakalar, çeker (dikkatini çeker)", "Fiil (3. Tekil)", "🎣"),
    ("captured", "yakaladı, çekti", "Fiil (V2/V3)", "🎣"),
    ("world", "dünya, alem", "İsim (Noun)", "🌍"),
    ("offer", "sunmak, teklif etmek / teklif", "Fiil / İsim", "🎁"),
    ("offers", "sunar, teklif eder / teklifler", "Fiil (3. Tekil) / Çoğul", "🎁"),
    ("offering", "sunma, takdim", "İsim / Fiil (-ing)", "🎁"),
    ("build", "inşa etmek, geliştirmek, kurmak", "Fiil (Action)", "🏗️"),
    ("building", "bina, yapı / inşa etme", "İsim / Fiil (-ing)", "🏢"),
    ("bid", "inşa etmek (build OCR yazım düzeltmesi)", "Fiil (Action)", "🏗️"),
    ("leaming", "öğrenme (learning OCR yazım düzeltmesi)", "İsim (Education)", "📚"),
    ("learning", "öğrenme, eğitim, öğrenim", "İsim (Education)", "📚"),
    ("way", "yol, yöntem, tarz, biçim", "İsim (Noun)", "🛤️"),
    ("ways", "yollar, yöntemler, biçimler", "Çoğul İsim", "🛤️"),
    ("skill", "beceri, yetenek, maharet", "İsim (Skill)", "⚡"),
    ("skills", "beceriler, yetenekler", "Çoğul İsim", "⚡"),
    ("habit", "alışkanlık, huy", "İsim (Noun)", "🔄"),
    ("habits", "alışkanlıklar", "Çoğul İsim", "🔄"),
    ("point", "nokta, husus, puan", "İsim (Noun)", "🎯"),
    ("points", "noktalar, hususlar, puanlar", "Çoğul İsim", "🎯"),
    ("item", "öğe, madde, parça", "İsim (Noun)", "📦"),
    ("items", "öğeler, maddeler, parçalar", "Çoğul İsim", "📦"),
    ("fact", "gerçek, olgu, hakikat", "İsim (Noun)", "💡"),
    ("facts", "gerçekler, olgular", "Çoğul İsim", "💡"),
